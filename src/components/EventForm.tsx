	...
	return (
		<Form onFinish={submitForm}>
			<Form.Item
				...
				name="desription" /* то же, что и в интерфейсе события */
				rules={[
			...
			<Form.Item
				label="Дата события"
				name="date" /* то же, что и в интерфейсе события */
				rules={[
					/* { required: true, message: 'Пожалуйста, введите имя пользователя!' }, */
					rules.required(), rules.isDateAfter("Нельзя создать событие в прошлом")
				]}
			>
			...
			<Form.Item
				...
				name="guest" /* то же, что и в интерфейсе события */
				rules={[
					/* { required: true, message: 'Пожалуйста, введите имя пользователя!' }, */
					rules.required(),
				]}
